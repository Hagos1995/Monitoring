...
$objForm.Text = "Ressourcen-Monitor"
    ...
    $TabControl.Controls.Add($Tab0)
       ...
       #Zeigt eine Liste der aktuellen Prozesse an in einem DataGrid an.      
       function ProcessList {
        ...
        $ProcessButton.Text = "Prozess Liste"
        $ProcessButton.Top = 40
        $ProcessButton.Left = 15
        $ProcessButton.Width = 150
        $ProcessButton.Anchor = [System.Windows.Forms.AnchorStyles]::Bottom -bor [System.Windows.Forms.AnchorStyles]::Right 
        $Tab0.Controls.Add($ProcessButton)

        

        #Aktion, bei Klicken des Buttons --> CPU Info als String in ein Textbox   
        $ProcessButton.add_click({ProcessList})
    ...
    $TabControl.Controls.Add($Tab4)
        ...
        $diskButton.Location = New-Object System.Drawing.Size(25,25)
        $diskButton.Size=New-Object System.Drawing.Size(150,23)
        $diskButton.Text = "Get DiskSpace"
        $diskButton.Name = "Get DiskSpace"
        $diskButton.DialogResult = "OK"
        $Tab4.Controls.Add($diskButton)

         $diskButton.Add_Click({GetDiskSpace})
